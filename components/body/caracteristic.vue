        ...
        <div class="flex flex-col gap-8">
          ...
          <div class="max-w-[500px]">
            <span class="font-secondary text-lg">
              ...
              atque deleniti dicta ea earum eius error explicabo, fugit id iste
              magnam magni molestias provident quam qui recusandae totam unde
              voluptatum.
            </span>
          </div>
            ...
            <Accordion v-model:value="activeAccordion">
              <TabList>
                <div class="flex flex-col gap-6">
                  <div
                    @click="switchActive(tab.value)"
                    v-for="tab in elements"
                    :class="[
                      'bg-[#142032] border-2 border-[#172a45] shadow-inner rounded-lg  ',
                      activeAccordion === tab.value ? 'shadow-2xl' : '',
                    ]"
                  >
                    <div
                      v-if="activeAccordion === tab.value"
                      class="w-full h-1 rounded-lg overflow-hidden"
                    >
                      <div
...
const elements = [
  {
    header: "Something 1",
    description:
      "Lorem ipsum dolor sit amet, consectetur adipisicing elit. A autem consequuntur enim iusto libero, maiores minima molestiae quidem reiciendis reprehenderit totam ut, voluptatibus! Cum excepturi impedit minus sed tenetur veritatis?\n",
    value: "0",
  },
  {
    header: "Something 2",
